...
public:
    ...
    void setTrackNoiseGateThresholdDb(int trackIndex, int moduleIndex, float thresholdDb);
    float getTrackNoiseGateThresholdDb(int trackIndex, int moduleIndex) const noexcept;
    void setTrackNoiseGateRatio(int trackIndex, int moduleIndex, float ratio);
    float getTrackNoiseGateRatio(int trackIndex, int moduleIndex) const noexcept;
    void setTrackNoiseGateAttackMs(int trackIndex, int moduleIndex, float attackMs);
    float getTrackNoiseGateAttackMs(int trackIndex, int moduleIndex) const noexcept;
    void setTrackNoiseGateReleaseMs(int trackIndex, int moduleIndex, float releaseMs);
    float getTrackNoiseGateReleaseMs(int trackIndex, int moduleIndex) const noexcept;
    void setTrackLimiterThresholdDb(int trackIndex, int moduleIndex, float thresholdDb);
    float getTrackLimiterThresholdDb(int trackIndex, int moduleIndex) const noexcept;
    void setTrackLimiterReleaseMs(int trackIndex, int moduleIndex, float releaseMs);
    float getTrackLimiterReleaseMs(int trackIndex, int moduleIndex) const noexcept;
    ...
    void setTrackChorusRate(int trackIndex, int moduleIndex, float rate);
    float getTrackChorusRate(int trackIndex, int moduleIndex) const noexcept;
    void setTrackChorusSyncEnabled(int trackIndex, int moduleIndex, bool shouldBeEnabled);
    bool isTrackChorusSyncEnabled(int trackIndex, int moduleIndex) const noexcept;
    void setTrackChorusSyncIndex(int trackIndex, int moduleIndex, int index);
    int getTrackChorusSyncIndex(int trackIndex, int moduleIndex) const noexcept;
    float getTrackResolvedChorusRateHz(int trackIndex, int moduleIndex) const noexcept;
    void setTrackChorusDepth(int trackIndex, int moduleIndex, float depth);
    float getTrackChorusDepth(int trackIndex, int moduleIndex) const noexcept;
    void setTrackChorusCentreFrequency(int trackIndex, int moduleIndex, float centreFrequency);
    float getTrackChorusCentreFrequency(int trackIndex, int moduleIndex) const noexcept;
    void setTrackChorusFeedback(int trackIndex, int moduleIndex, float feedback);
    float getTrackChorusFeedback(int trackIndex, int moduleIndex) const noexcept;
    void setTrackChorusMix(int trackIndex, int moduleIndex, float mix);
    float getTrackChorusMix(int trackIndex, int moduleIndex) const noexcept;
    ...
    void setSendBusNoiseGateThresholdDb(int sendIndex, int moduleIndex, float thresholdDb);
    float getSendBusNoiseGateThresholdDb(int sendIndex, int moduleIndex) const noexcept;
    void setSendBusNoiseGateRatio(int sendIndex, int moduleIndex, float ratio);
    float getSendBusNoiseGateRatio(int sendIndex, int moduleIndex) const noexcept;
    void setSendBusNoiseGateAttackMs(int sendIndex, int moduleIndex, float attackMs);
    float getSendBusNoiseGateAttackMs(int sendIndex, int moduleIndex) const noexcept;
    void setSendBusNoiseGateReleaseMs(int sendIndex, int moduleIndex, float releaseMs);
    float getSendBusNoiseGateReleaseMs(int sendIndex, int moduleIndex) const noexcept;
    void setSendBusLimiterThresholdDb(int sendIndex, int moduleIndex, float thresholdDb);
    float getSendBusLimiterThresholdDb(int sendIndex, int moduleIndex) const noexcept;
    void setSendBusLimiterReleaseMs(int sendIndex, int moduleIndex, float releaseMs);
    float getSendBusLimiterReleaseMs(int sendIndex, int moduleIndex) const noexcept;
    ...
    void setSendBusChorusRate(int sendIndex, int moduleIndex, float rate);
    float getSendBusChorusRate(int sendIndex, int moduleIndex) const noexcept;
    void setSendBusChorusSyncEnabled(int sendIndex, int moduleIndex, bool shouldBeEnabled);
    bool isSendBusChorusSyncEnabled(int sendIndex, int moduleIndex) const noexcept;
    void setSendBusChorusSyncIndex(int sendIndex, int moduleIndex, int index);
    int getSendBusChorusSyncIndex(int sendIndex, int moduleIndex) const noexcept;
    float getSendBusResolvedChorusRateHz(int sendIndex, int moduleIndex) const noexcept;
    void setSendBusChorusDepth(int sendIndex, int moduleIndex, float depth);
    float getSendBusChorusDepth(int sendIndex, int moduleIndex) const noexcept;
    void setSendBusChorusCentreFrequency(int sendIndex, int moduleIndex, float centreFrequency);
    float getSendBusChorusCentreFrequency(int sendIndex, int moduleIndex) const noexcept;
    void setSendBusChorusFeedback(int sendIndex, int moduleIndex, float feedback);
    float getSendBusChorusFeedback(int sendIndex, int moduleIndex) const noexcept;
    void setSendBusChorusMix(int sendIndex, int moduleIndex, float mix);
    float getSendBusChorusMix(int sendIndex, int moduleIndex) const noexcept;
...
private:
    ...
    float processNoiseGateModule(ModuleChain& chain, int moduleIndex, int channel, float sample) const noexcept;
    float processLimiterModule(ModuleChain& chain, int moduleIndex, int channel, float sample) const noexcept;
    ...
    float processChorusModule(ModuleChain& chain, int moduleIndex, int channel, float sample) const noexcept;
    ...
    float getResolvedChorusRateHz(const ModuleChain& chain, int moduleIndex) const noexcept;
